            ...
            <!-- <p class="lead">Some Description Here.</p> -->
              ...
              <div class="col-12">
               <p><h2>විභාග</h2></p>
                ...
                <div class="row g-3">
                  <div class="col-sm-6">
                    <label for="al" class="form-label">විභාගයේ නම: </label>
                ...
                <div class="invalid-feedback">
                  ...
                  <div class="col-sm-6">
                    <label for="ol" class="form-label">වර්ෂය:</label>
                ...
                <div class="invalid-feedback">
                  ...
                  <div class="row g-3">
                    <div class="col-sm-6">
                      <label for="g5" class="form-label">විභාග අංකය:</label>
                    ...
                    <div class="col-sm-6">
                      <label for="other" class="form-label">ලබාගත් ලකුණු ප්‍රමානය:</label>
                      <input type="number" class="form-control" id="" placeholder="" value="" required>
                      <div class="invalid-feedback">
                    ...
                    <div id="saved"></div>
                    <hr class="my-4">
                    <a href="sindex1.1.php" class="btn btn-primary btn-lg">ආපසු </a>
